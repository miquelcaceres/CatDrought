...
In this mode, the soil water balance model is used to simulate water balance for the historical period between 1990 and 2015. Unlike current-day simulations, climate change simulations are conducted for forest inventory plots only. Moreover, only monthly and yearly summaries are stored. 
...
Historic weather series for each forest plot is obtained by interpolating daily weather station data for the 1990-2015 period, using package *meteoland*. Surface weather station data was obtained from the [Agencia Estatal de Meteorologia (AEMET)](http://www.aemet.es) and [Servei Meteorologic de Catalunya (SMC)](http://www.meteo.cat).
...
MODE 2/3           | Plot interpolation 1990-2015 |  1 week            | No         | No    |
MODE 2 (historic)  | Soil water balance IFN2/IFN3 |  18 hours          | No         | No    |
MODE 2 (historic)  | Merging IFN2-IFN3 outputs    |  5 min             | No         | No    |
MODE 2 (historic)  | Mapping                      |  30 min            | No         | No    |
MODE 3 (projection)| Bias correction & SWB        |  1 week            | No         | No    |
